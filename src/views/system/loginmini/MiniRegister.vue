                ...
                <div class="aui-account aui-account-line">
                  <a-form-item>
                    <div class="aui-input-row">
                      <div class="aui-input-line aui-input-line-half">
                      ...
                      <div class="aui-input-line aui-input-line-half">
                        <Icon class="aui-icon" icon="ant-design:user-outlined"/>
                        <a-input class="fix-auto-fill" type="text" placeholder="真实姓名" v-model:value="formData.realname" />
                      </div>
                    </div>
                  </a-form-item>
                  <a-form-item>
...
<script lang="ts" setup name="mini-register">
   ...
   */
  function initForm() {
    Object.assign(formData,{username:'', realname: '', mobile: '', smscode: '', password: '', confirmPassword: ''})
    if(!unref(timer)){
      showInterval.value = true;
      clearInterval(unref(timer));
      timer.value = null;
